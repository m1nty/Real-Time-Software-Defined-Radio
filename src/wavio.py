...
##	# parse an audio file
    audio_Fs, audio_data = wavfile.read("../data/fmMonoBasic.wav")
    print(audio_Fs)
...
#        print(float_data[i])
    ...
    wavfile.write("../data/audio_processed.wav", audio_Fs, np.int16((float_data/2)*32767))
