...
if __name__ == "__main__":
    ...
    while (block_count+1)*block_size < len(iq_data):
        ...
        #---------------TAKE HOME EXERCISE-----------------
        i_filt, state_i_lpf_100k = my_convoloution(iq_data[(block_count)*block_size:(block_count+1)*block_size:2], rf_coeff, rf_taps, state_i_lpf_100k)
        q_filt, state_q_lpf_100k = my_convoloution(iq_data[(block_count)*block_size+1:(block_count+1)*block_size:2], rf_coeff, rf_taps, state_q_lpf_100k) 
        ...
        #---------------TAKE HOME EXERCISE-----------------
        audio_filt, audio_pre_state = my_convoloution(fm_demod,audio_coeff, audio_taps, audio_pre_state)
